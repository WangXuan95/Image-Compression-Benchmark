...
This repo shows the performance of several state-of-the-art lossless image compression formats when compressing **RGB 24-bit** and **Gray 8-bit** images. Inspired by [LPCB authored by Alex Rhatushnyak](http://qlic.altervista.org/) , but use a larger dataset, and provides a convenient Python script to run the benchmark.

**Compress formats**: See [README_FormatList.md](./README_FormatList.md) .
...
Benchmark dataset : [**585 .pnm uncompressed RGB 24-bit image files**](README_RGB24dataset.md), totaling **4 GB**.

Note: All following results are **strictly lossless compression**.
...
QLIC2                 | 1461101919  35.71% |      29.899     |      30.152      |  FLIC.exe c out.flic in.pnm                                                | FLIC.exe d in.flic out.pnm                      | Win_x64
BIM                   | 1472723769  35.99% |     187.279     |     211.560      |  FLIC.exe c out.flic in.pnm                                                | FLIC.exe d in.flic out.pnm                      | Win_x64
HALIC                 | 1473481803  36.01% |      22.187     |      28.447      |  HALIC072e.exe in.pnm out                                                  | HALIC072d.exe in out.pnm                        | Win_x64
...
HALICfast             | 1537725512  37.58% |      19.112     |      23.784      |  HALIC072e.exe in.pnm out                                                  | HALIC072d.exe in out.pnm                        | Win_x64
...
QIC                   | 1699046729  41.52% |      19.942     |      20.639      |  FLIC.exe c out.flic in.pnm                                                | FLIC.exe d in.flic out.pnm                      | Win_x64
...
QOI                   | 2280217586  55.73% |      19.061     |      18.970      |  Image.open('in.pnm').save('out.j2k',format='JPEG2000',irreversible=False) | Image.open('in.j2k').save('out.pnm')            | Python Pillow
...
| :--:                       |
| Figure: benchmark result of RGB 24-bit image compression |
...
Benchmark dataset : [**64 .pnm uncompressed Gray 8-bit image files**](README_Gray8dataset.md), totaling **751 MB**.
...
| :--:                       |
| Figure: benchmark result of Gray 8-bit image compression |
